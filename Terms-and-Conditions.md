...
The App may incorporate open-source software components, each of which is subject to its own license terms. Use of those components is governed by their respective licenses.
...
If you download the App from the Apple App Store, you acknowledge that these Terms are between you and the Developer only, not with Apple Inc. Apple has no obligation to provide any maintenance or support for the App. To the extent permitted by law, Apple has no warranty obligation. Apple is not responsible for addressing any claims relating to the App.

### 4.2 Google Play Store

If you download the App from the Google Play Store, you acknowledge that these Terms are between you and the Developer only, not with Google LLC. Google has no obligation to provide support for the App.
...
The App, including its design, interface, graphics, and code, is the intellectual property of Giacomo Cavallini and is protected by copyright and other applicable intellectual property laws. Nothing in these Terms grants you any rights to the Developer's intellectual property other than the limited license described in Section 3.
...
To the maximum extent permitted by applicable law, the Developer disclaims all warranties, including but not limited to:
...
You agree to indemnify, defend, and hold harmless the Developer from and against any claims, liabilities, damages, losses, and expenses (including reasonable legal fees) arising out of or in connection with:
...
Upon termination, all rights granted to you under these Terms will immediately cease. Sections 8, 9, 10, 11, 14, and 15 will survive termination.
